...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_6x6_kinesis(
        ...
        KC_LCTL, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                           KC_N   , KC_M   , KC_COMMA   , KC_DOT  , KC_SLASH, MO(3),
                          KC_TRNS, MO(3), KC_INS, LGUI(KC_D), MO(1),                     KC_LEFT , KC_DOWN  , KC_UP, KC_RIGHT, KC_LGUI,
                          KC_BSPC ,KC_LSFT  , KC_ESC , KC_LALT, KC_LGUI,                  KC_LCTL ,KC_ENT , MO(2) , KC_SPC, KC_LALT
    ),
    ...
    [1] = LAYOUT_6x6_kinesis(
        ...
        KC_TAB, LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), LGUI(KC_0), LGUI(KC_F1) ,                 KC_PGUP   , KC_HOME,       KC_UP   , KC_END   , KC_INS, KC_ENT,
        KC_LSFT, KC_LSFT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS   ,             KC_PGDN   , KC_LEFT   , KC_DOWN   , KC_RIGHT   , KC_DEL, MO(3),
                 KC_GRV , MO(2)  , QK_BOOT, LGUI(KC_D), KC_TRNS,                         LSG(KC_Q) , MO(2)  , QK_BOOT, QK_BOOT, MO(3),
